 ...
 * @author ASUS
 */
@WebServlet(name = "RemoveItemFromCardServlet", urlPatterns = {"/RemoveItemFromCardServlet"})
public class RemoveItemFromCardServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                if (tmp != null) {
                    list.remove(tmp);
                    listBook.get(indexForBook).setQuantity(listBook.get(indexForBook).getQuantity() + tmp.getQuantity());
