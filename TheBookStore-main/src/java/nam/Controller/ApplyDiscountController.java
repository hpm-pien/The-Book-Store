 ...
 * @author ASUS
 */
@WebServlet(name = "ApplyDiscountController", urlPatterns = {"/ApplyDiscountController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(session!=null){
                ...
                List<DiscountDTO> listDisCount = (List<DiscountDTO>) session.getAttribute("ListDiscount");
                for (DiscountDTO d : listDisCount) {
                    if(d.getDiscountID() == Integer.parseInt(discountID)){
                        discountPercent = d.getDiscountPercent();
                    }
                }
                
                session.setAttribute("Order", order);
                request.setAttribute("disCount", discountID);
