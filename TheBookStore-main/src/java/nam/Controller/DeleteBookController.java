...
public class DeleteBookController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bookID != null) {
                int rs = dao.removeBookStore(Integer.parseInt(bookID));
                if (rs > 0) {
            ...
            log("DeleteBookController + SQLException: " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
            log("DeleteBookController + ClassNotFound: " + ex.getMessage());
        } finally {
